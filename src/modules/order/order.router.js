...
const router = Router();
router.post('/',auth(endpoints.create),validation(validators.createOrder),asyncHandler(orderController.createOrder))
...
router.patch('/:orderId',auth(endpoints.updateOrder),validation(validators.updateStatus),asyncHandler(orderController.changeStatus));
